    ...
    <section className="container pt-4">
        <div className="row align-items-center">
            <div className="col-auto pr-5" style={{ width: 530 }}>
                ...
                <Button className="btn px-5 btn-shadow btn-primary" hasShadow isPrimary onClick={showMostPicked}>
                    Show Me Now
                </Button>
                <div className="row" style={{ marginTop: 80 }}>
                    <div className="col-auto" style={{ marginRight: 35 }}>
                        <img width="36" height="36" src={`${process.env.PUBLIC_URL}/images/icon-traveller.svg`} alt={`${props.data.travelers} Travelers`} />
                        <h6 className="mt-3">
